...
class mobil_kecil : public mobil {
	public :
...
class mobil_besar : public mobil {
	public :
...
class pinjam_mobil : public mobil {
	int pil;
	int pil2, pil3;
	public :
		peminjam customer;
					...
					switch (pil2){
						case 1 :{
							...
							if (kia <=0){
								...
								cout<<"sudah termasuk biaya bensin dan supir"<<endl;
								kia=kia-1;
								pemasukan=pemasukan+390000;
							}
							break;
						}
						case 2 :{
